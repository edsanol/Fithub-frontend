...
const config: Config = {
  ...
  // cacheDirectory: "C:\\Users\\edsanol21\\AppData\\Local\\Temp\\jest",
  ...
  collectCoverageFrom: [
    "src/**/*.{ts,tsx}", // Incluye todos los archivos TypeScript/TSX en la carpeta src
    "!src/**/*.d.ts", // Excluye archivos de definición de TypeScript
    "!src/**/index.ts", // Excluye archivos de índice si es necesario
    "!src/**/types.ts", // Excluye archivos de tipos si los tienes
    "!src/assets/**", // Excluye la carpeta src/assets
    "!src/types/**", // Excluye la carpeta src/types
    "!src/config/**", // Excluye la carpeta src/config
