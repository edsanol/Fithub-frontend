...
export interface AthleteUserService {
  ...
  getAthleteUserList(data: PaginateData): Promise<PaginateResponseList<AthleteUser>>;
  ...
  getMeasurementProgressList(id: number, data: PaginateData): Promise<PaginateResponseList<MeasurementsProgress>>;
